!(function (e) {
  ...
  e.fn.planetarium = function (r) {
    ...
    s.each(function (t, n) {
      function w(t) {
        var n = { x: false, y: false },
          r = { x: y.x - (g.x - t.clientX), y: y.y - (g.y - t.clientY) };
        n.x = true;
        if (b && n.x) {
          y.x = r.x;
          y.y = 0;
        ...
        e(this)
          .find(".ptr-planet")
          .css("background-position", y.x + "px " + y.y + "px");
        g.x = t.clientX;
        g.y = t.clientY;
        t.stopPropagation();
        return false;
      ...
      var r = e(this);
      var s = r.data("ptr-autospin") || i.autospin,
        o = r.data("ptr-angle") || i.angle,
        u = r.data("ptr-glow") || i.glow,
        a = r.data("ptr-pattern") || i.pattern,
        f = r.data("ptr-size") || i.size,
        l = r.data("ptr-float") || i.float,
        c = r.data("ptr-ring") || i.ring,
        h = r.data("ptr-ringcolor") || i.ringColor,
        p = r.data("ptr-ringangle") || i.ringAngle,
        d = f.split("x");
      ...
      if (c == true) {
        ...
        r.find(".ptr-ring").css({
          ...
          width: d[0] * 1.5,
          transform: "rotate(" + p + ")",
          "-moz-transform": "rotate(" + p + ")",
          "-webkit-transform": "rotate(" + p + ")",
          "margin-left": ((d[0] * 1.5) / 2) * -1,
          "margin-top": -1.5,
        });
      }
      ...
      if (s != false) {
        r.find(".ptr-planet").css({
          ...
          "-webkit-animation": "rotate " + s + " infinite linear",
          "-moz-animation": "rotate " + s + " infinite linear",
        });
      }
      var v = r.find(".ptr-planet"),
        m = {
          w: parseInt(v.parent().width()),
          h: parseInt(v.parent().height()),
        },
        g = { x: 0, y: 0 },
        y = { x: 0, y: 0 },
        b = false;
